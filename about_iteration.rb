...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject returns the result of the block with the first argument
    # being the sum or product of all items in the array and the second (item)
    # being the number that is passed to inject
  end
