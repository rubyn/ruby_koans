...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # So .send doesn't conflict with other send methods in libraries that are imported into the
    # global namesapce
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # If method_missing is redefined it will be called anytime and unknown method is
    # called on an object of that class, which will allow us to customize the behavior and/or
