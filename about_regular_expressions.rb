...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # When would * fail to match?
      # Never! will always return "" at least when tested against a string
      #If no match is found in the fifst letter then "" would be returned
      #ie: "abcde"[/b*/] would return "" not "b"
  end

  # THINK ABOUT IT:
  #
  # We say that the repetition operators above are "greedy."  Why?
  #   Because the + operater will continue searching for matches until it fails so .+> will
  #   continue to the end of the line before giving up and then beginning backtracking.
  #   Since "<h1>hello</h1><p>this isn't what we wanted</p> test" has multiple '>' once .+ gets
  #   to the end of the line it will backtrack looking for '>' and will find it at the last </p>
  #   So the returned string will be: "<h1>hello</h1><p>this isn't what we wanted</p>" instead of
  #   "<h1>" that we were hoping for regex will return the first match so when backtracing that
  #   means it will return the last '>' on the line
