...
class AboutClassMethods < Neo::Koan
  ...
  # I find def self.method is easier to read and maintain and reduces confusion since the
  # class << self could be overlooked when reviewing the code later, sort of like how a with
  # statement makes code harder to read and follow sometimes
