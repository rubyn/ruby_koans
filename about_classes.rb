...
class AboutClasses < Neo::Koan
  ...
  def test_args_to_new_must_match_initialize
    ...
    # Why is this so?
    # -------- ANSWER -------
    # The .new method automaticlaly calls the initialize method which requires the initial_name
    # argument so without initial_name the initialize method throws an ArgumentError
  end
